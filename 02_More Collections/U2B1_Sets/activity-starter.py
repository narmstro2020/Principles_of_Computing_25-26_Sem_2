...
def view_my_playlist():
    ...
    # TODO: Call display_songs() with my_playlist and an appropriate title
...
def remove_songs():
    ...
    while True:
        ...
        # If yes, remove it using .discard() and confirm
        # If no, print a message that it's not in the playlist
        #
        # HINT: Check with 'if song in my_playlist'
        # HINT: Use my_playlist.discard(song) for safe removal
...
def find_common_songs():
    ...
    if common:
        ...
        # TODO: Calculate what percentage of your songs are shared
        # HINT: (len(common) / len(my_playlist)) * 100
...
def get_recommendations():
    ...
    # YOUR CODE HERE:
    recommendations = set()  # Replace this!
